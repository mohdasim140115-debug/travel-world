...
export async function cancelHotelBooking({ bookingRef, reason }) {
  ...
  let result;
  try {
    result = await hotelsOps.cancel({ supplierBookingId: booking.supplierBookingId, reason: reason ?? null });
  } catch (error) {
