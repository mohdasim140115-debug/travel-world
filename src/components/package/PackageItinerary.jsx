      ...
      {itinerary.map((day, index) => {
        ...
        return (
          <div key={day.day} className="relative flex gap-4 pb-4">
            ...
            <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#17BEBB] text-[11px] font-bold text-white">
              {day.day}
            </div>

            <div className="flex-1 overflow-hidden rounded-xl border bg-[#fafafa]">
              <button
                type="button"
              ...
              >
                ...
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[#c9d3e2] text-[#0F4C81]">
