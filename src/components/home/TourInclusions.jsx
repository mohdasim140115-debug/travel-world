    ...
    <section className="px-3 py-12 sm:px-6 lg:px-0">
      <div className="mx-auto w-full max-w-[1280px]">
        <div className="text-center">
          ...
          <div className="mt-3 h-1 w-16 rounded-full bg-[#0F4C81] mx-auto" />
        </div>
              ...
              <div key={feature.title} className="text-center">
                <div className="flex justify-center">
                  <div className="flex h-[70px] w-[70px] items-center justify-center rounded-full bg-[#F0F4F8]">
                    <Icon className="h-8 w-8 text-[#0F4C81]" />
                  </div>
                </div>
                <h3 className="mt-4 text-[15px] font-bold text-[#0F172A]">{feature.title}</h3>
