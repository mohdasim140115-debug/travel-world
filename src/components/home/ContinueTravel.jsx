  ...
  return (
    <section className="bg-[#F3F6FA] px-4 py-12 sm:px-6 lg:px-0">
      <div className="mx-auto w-full max-w-[1280px]">
        <h2 className="text-[22px] font-bold text-[#0B1F3A]">{continueTravel.heading}</h2>
          ...
          {continueTravel.tours.map((tour) => (
            ...
            >
              <div className="flex flex-col">
                ...
                <div className="p-3">
                  <h4 className="text-[13px] font-bold text-[#0B1F3A]">{tour.name}</h4>
                  <p className="mt-1 text-[12px] text-[#60646C]">{tour.duration}</p>
                  <p className="mt-1 text-[13px] font-bold text-[#0B1F3A]">{tour.price}</p>
                  <p className="text-[11px] text-[#60646C]">twin sharing</p>
                  <span className="mt-3 block text-[12px] font-semibold text-[#2563EB]">
                    {tour.cta} &gt;
                  </span>
                </div>
              </div>
